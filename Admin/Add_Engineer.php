<?php
    ...
    include("Database/Add_Engineer.php");
    ...
    if(isset($_POST["submit"]))
    {
        if(CheckUsername())
        {
            ...
            {
                $error_msg = "Team Leader doesnt Exist";
            }
        }
        else
        {
...
<div class="container">
    ...
    <main role="main" class="text-center py-5 mx-auto" style="max-width: 576px;">
        ...
        <div class="bg-blue text-white container ms-auto w-lg-50 rounded d-flex flex-column mt-5">
            ...
            <h2 class="pb-4 pt-4 m-0">Add Engineer Account</h2>
            ...
            <div class="container mt-3">
                ...
                <form method="post" class="d-flex">
                    ...
                    <div class="input-group-lg mx-2 w-100">
                        ...
                        <div class="form-floating text-black">
                            <input type="text" class="form-control my-3" id="floatingTL"
                                placeholder="Team Leader Username" name="tl_username" required>
                            <label for="floatingTL">Team Leader Username</label>
                        </div>
