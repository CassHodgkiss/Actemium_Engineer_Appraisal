<?php
    ...
    include("Database/Appraisal_Engineers_Data.php");

    $appraisal_data = GetEngineerAppraisalData($appraisal_id);
                ...
                <table class="table m-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-0">
                                <a href="Appraisal_Engineer_Question_Data.php?id=<?php echo $appraisal_id; ?>&num=<?php echo $i; ?>"
