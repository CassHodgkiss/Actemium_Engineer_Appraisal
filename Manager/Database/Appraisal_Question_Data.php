<?php
    ...
    function GetTeamLeaderAppraisalAnswerData($appraisal_id, $appraisal_question)
    {
        ...
        $sql = "SELECT * FROM Team_Leaders tl
        INNER JOIN Team_Leader_Appraisals tla ON tl.team_leader_username = tla.team_leader_username
        INNER JOIN Team_Leaders_Appraisal_Answers tlaa ON tla.team_leader_appraisal_id = tlaa.team_leader_appraisal_id
        INNER JOIN Answers an ON tlaa.answer_id = an.answer_id 
        INNER JOIN Questions q ON an.question_id = q.question_id 
        INNER JOIN Appraisals_Questions aq ON q.question_id = aq.question_id AND aq.appraisal_id = :appraisal_id
        WHERE tla.appraisal_id = :appraisal_id 
        AND aq.question_num = :appraisal_question";
