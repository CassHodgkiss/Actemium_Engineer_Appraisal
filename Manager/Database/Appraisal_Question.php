<?php
    ...
    function GetAppraisalData($manager_appraisal_id)
    {
        ...
        WHERE ea.manager_appraisal_id = :manager_appraisal_id 
        AND ea.manager_username = :manager_username";

        $stmt = $db->prepare($sql);

        $stmt->bindValue(':manager_username', $_SESSION["Username"], SQLITE3_TEXT);
        $stmt->bindValue(':manager_appraisal_id', $manager_appraisal_id , SQLITE3_INTEGER);
    ...
    //Returns Required Data for the Appraisal Questions Page
    function GetAppraisalQuestionData($manager_appraisal_id , $appraisal_question)
    {
        $db = new SQLITE3('C:/xampp/data/actemium.db');
    ...
    function GetAppraisalAnswerData($manager_appraisal_id)
    {
        $db = new SQLITE3('C:/xampp/data/actemium.db');

        $sql = "SELECT * FROM Team_leader_Appraisals ea 
        INNER JOIN Team_leaders_Appraisal_Answers eaa ON ea.manager_appraisal_id = eaa.manager_appraisal_id
        ...
        WHERE ea.manager_username = :manager_username 
        AND ea.manager_appraisal_id = :manager_appraisal_id 
