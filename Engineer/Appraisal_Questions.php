<?php
    ...
    $appraisal_data = GetAppraisalData($engineer_appraisal_id, $appraisal_question);
    ...
    if(isset($_POST["submit"])) 
    {
        ...
        if(!$has_error){
            ...
            if($answered_current){
                UpdateAnswer($appraisal_data["engineer_appraisal_id"], $appraisal_data["question_id"], $appraisal_data["question_type"], $answer);
            }
            else{
                SaveAnswer($appraisal_data["engineer_appraisal_id"], $appraisal_data["question_id"], $appraisal_data["question_type"], $answer);
            }
