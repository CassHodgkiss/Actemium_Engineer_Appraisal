...
function createSeller(){
    ...
    $sql = 'INSERT INTO 
    Sellers(seller_username, seller_firstname, seller_lastname, seller_password, seller_email, seller_phone, seller_address_1, seller_address_2, seller_penalty, seller_status) 
